...
This assignment is due on |dueday|, |ass3due| at |duetime|.


Source files
------------

This assignment consists of the Coq script ``Tactics.v``.
...
Submit your completed files as the CodePost assignment ``Assignment 3``.
